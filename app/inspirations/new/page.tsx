  ...
  return (
    <main className="page-shell py-10 sm:py-16">
      <div className="mx-auto max-w-3xl">
        <p className="eyebrow text-[#1822ff]">CREATE</p>
        ...
        <div className="mt-10 rounded-[2rem] border border-black/10 bg-[#f7f7f2] p-5 sm:p-9"><InspirationForm parentId={parent} /></div>
      </div>
    </main>
  );
}
