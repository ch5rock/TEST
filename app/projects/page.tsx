...
export default async function ProjectsPage() {
  ...
  return (
    <main className="page-shell py-10 sm:py-14"><div className="mx-auto max-w-6xl">
      <p className="eyebrow text-[#1822ff]">PROJECTS</p>
      <div className="mt-3 flex items-end justify-between gap-4"><h1 className="text-4xl font-black tracking-[-0.055em] sm:text-7xl">함께 만드는 중.</h1><Users className="hidden size-12 text-black/15 sm:block" /></div>
